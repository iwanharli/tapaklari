<div class="tf-widget-events">
    <div class="themeflat-container">
        <div class="event-detail-box">
            <h2 class="title-event-detail title-small wow fadeInUp animated ">Running Events Coming Up include</h2>
            <div class="detail-box-content">
                <div class="image-event">
                    <img src="{{ asset('portal/images/evtent/evt2.jpg') }}" alt="Image Events"
                        class="wow fadeInLeft animated">
                </div>
                <div class="event-detail-card">
                    <div class="event-detail-container">
                        <h4 class="event-detail-heading">Ticket</h4>
                        <p class="price">
                            <span>$45</span>
                            <span class="ticket-price">/ticket</span>
                        </p>
                        <p class="event-title">TapakLari Fun Run 2023 - Run, Connect, Thrive!</p>
                        <div class="event-date-time-or-location">
                            <div class="event-date-time">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_6600_3485)">
                                        <path
                            ...
                            <div class="event-date-time">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_6600_3490)">
                                        <path
                            ...
                            <div class="event-date-time">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_6600_3495)">
                                        <path
                        ...
                        <div class="btn-learn-more">
                            <a href="#" class="flat-button">Join now</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="event-detail-content">
                    <h3 class="wow fadeInUp animated">Zunzo Fun Run 2023 - Run, Connect, Thrive!</h3>
                    <p class="post wow fadeInUp animated">Zunzo is delighted to present our exciting running event -
                    ...
                    <p class="post regis-now wow fadeInUp animated">Register now, and don't miss out on this
                        incredible opportunity!</p>
                    <a href="#" class="flat-button wow fadeInUp animated">Register now</a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="image-event-content">
                    <img src="{{ asset('portal/images/evtent/evt1.jpg') }}" alt=""
