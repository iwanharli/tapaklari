    ...
    <div class="tf-slider swiper-wrapper">
        <div class="tf-banner swiper-slide">
            <div class="image-slider">
                <img src="{{ asset('portal/images/slides/slide1.jpg') }}" alt="image" />
            ...
            <div class="themeflat-container">
                <div class="slide-item">
                    ...
                    <div class="box-events-slide">
                        ...
                        <img src="{{ asset('portal/images/evtent/new-event.jpg') }}" alt="image event"
                            class="new-event">
        ...
        <div class="tf-banner swiper-slide">
            <div class="image-slider">
                <img src="{{ asset('portal/images/slides/slide2.jpg') }}" alt="image" />
                <div class="overlay"></div>
            </div>
            <div class="themeflat-container">
                <div class="slide-item">
                    ...
                    <div class="box-events-slide">
                        <span class="new-event">new Event </span>
                        <img src="{{ asset('portal/images/evtent/new-event.jpg') }}" alt="" class="new-event">
                        <div class="content-event">
                            <h2 class="title-event"><a href="event-details.html" class="">marathon event
                                    2023</a>
                            </h2>
        ...
        <div class="tf-banner swiper-slide">
            <div class="image-slider">
                <img src="{{ asset('portal/images/slides/slide3.jpg') }}" alt="image" />
                <div class="overlay"></div>
            </div>
            <div class="themeflat-container">
                <div class="slide-item">
                    ...
                    <div class="box-events-slide">
                        <span class="new-event">new Event </span>
                        <img src="{{ asset('portal/images/evtent/new-event.jpg') }}" alt=""
                            class="new-event">
                        <div class="content-event">
                            <h2 class="title-event"><a href="event-details.html" class="">marathon event
                                    2023</a>
