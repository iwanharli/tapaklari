...
; (function ($) {
    ...
    var retinaLogos = function () {
        ...
        if (retina) {
            $('#a2').attr({ src: './portal/images/logo.png', width: '190', height: '42' });
            $('#a3').attr({ src: './portal/images/logo-v2.png', width: '124', height: '42' });
            $('#a1').attr({ src: './portal/images/logo-footer.png', width: '125', height: '43' });
