                        ...
                        <div class="swiper-testimonial">
                            ...
                            <div class="swiper-slide">
                                <div class="tf-testimonial-content">
                                    <div class="user-info">
                                        <img class="icon-testimonil"
                                            src="{{ asset('portal/images/testimonial/Graphic.png') }}" alt="">
                                        <div class="avata">
                                            <img src="{{ asset('portal/images/testimonial/profile.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="info">
                ...
                <div class="col-md-12 col-lg-5 col-xl-5 col-xxl-5">
                    <div class="testimonial-wrap">
                        <div class="testimonial-box wow fadeInUp animated " data-wow-delay="0.3s">
                            ...
                            <p class="testimonial">"I've always struggled with staying consistent with exercise,
                                but
