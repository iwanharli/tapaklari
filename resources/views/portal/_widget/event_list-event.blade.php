        ...
        <div class="widget-event">
            <div class="item wow fadeInUp animated">
                <div class="event-infomation">
                    <div class="info">
                        <h4><a href="{{ route('event-detail', ['slug' => 'example-slug', 'date' => '2024-08-08']) }}">denpasar
                                marathon event 2023</a></h4>
                        <p>
                            <span>
                    ...
                    <img decoding="async" src="{{ asset('portal/images/evtent/event1.jpg') }}"
                        alt="denpasar marathon event 2023">
                </div>
                <div class="tf-info-price">
                    <h4>Ticket</h4>
                    <p class="price"><span>$45</span>/ticket</p>
                    <a href="{{ route('event-detail', ['slug' => 'example-slug', 'date' => '2024-08-08']) }}"
                        class="flat-button ">Learn more</a>
            ...
            <div class="item wow fadeInUp animated">
                <div class="event-infomation">
                    <div class="info">
                        <h4><a href="{{ route('event-detail', ['slug' => 'example-slug', 'date' => '2024-08-08']) }}">women
                                marathon event 2023</a></h4>
                        <p>
                            <span>
                                <svg width="18" height="22" viewBox="0 0 18 22" fill="none"
                    ...
                    <img decoding="async" src="{{ asset('portal/images/evtent/event4.jpg') }}"
                        alt="denpasar marathon event 2023">
                </div>
                <div class="tf-info-price">
                    <h4>Ticket</h4>
            ...
            <div class="item wow fadeInUp animated">
                <div class="event-infomation">
                    ...
                    <img decoding="async" src="{{ asset('portal/images/evtent/event2.jpg') }}"
                        alt="denpasar marathon event 2023">
                </div>
                <div class="tf-info-price">
                    <h4>Ticket</h4>
            ...
            <div class="item wow fadeInUp animated">
                <div class="event-infomation">
                    ...
                    <img decoding="async" src="{{ asset('portal/images/evtent/event3.jpg') }}"
                        alt="denpasar marathon event 2023">
                </div>
                <div class="tf-info-price">
                    <h4>Ticket</h4>
